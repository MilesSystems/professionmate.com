                        ...
                        <form method="post" action="#">
                            <div className="row gtr-uniform">
                                ...
                                <div className="col-4 col-12-small">
                                    ...
                                    <label form="demo-priority-low">Low</label>
                                </div>
                                <div className="col-4 col-12-small">
                                    <input type="radio" id="demo-priority-normal" name="demo-priority"/>
                                    <label form="demo-priority-normal">Normal</label>
                                </div>
                                <div className="col-4 col-12-small">
                                    <input type="radio" id="demo-priority-high" name="demo-priority"/>
                                    <label form="demo-priority-high">High</label>
                                </div>
                                <div className="col-6 col-12-small">
                                    <input type="checkbox" id="demo-copy" name="demo-copy"/>
                                    <label form="demo-copy">Email me a copy</label>
                                </div>
                                <div className="col-6 col-12-small">
                                    <input type="checkbox" id="demo-human" name="demo-human" checked/>
                                    <label form="demo-human">Not a robot</label>
                                </div>
                                <div className="col-12">
                    ...
                    <section>
                        ...
                        <div className="box alt">
                            <div className="row gtr-50 gtr-uniform">
                                <div className="col-12"><span className="image fit"><img src="images/banner.jpg"
                                                                                         alt=""/></span></div>
                        ...
                        <h5>Left &amp; Right</h5>
                        <p><span className="image left"><img src="images/pic04.jpg" alt=""/></span>Morbi mattis mi
                        ...
                        <p><span className="image right"><img src="images/pic05.jpg" alt=""/></span>Vestibulum ultrices
